...
const buttonVariants = cva(
  "inline-flex uppercase items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
        ...
        primaryOutline: "bg-white text-sky-500 hover:bg-sky-50",
        ...
        sidebar:
          "bg-transparent text-slate-500 transition-none border-transparent hover:bg-slate-100 border-0",
        sidebarOutline:
